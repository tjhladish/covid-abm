importData = read.table("mmod_v2.2.csv", header=T, sep='\t', stringsAsFactors = F)
...
closedQuantiles$prob_outbreak[closedQuantiles$quartile == 50] <- outbreakProbs$x[outbreakProbs$Group.1 == 0]
...
twoWeeksQuantiles$prob_outbreak[twoWeeksQuantiles$quartile == 50] <- outbreakProbs$x[outbreakProbs$Group.1 == 1]
...
onePercentQuantiles$prob_outbreak[onePercentQuantiles$quartile == 50] <- outbreakProbs$x[outbreakProbs$Group.1 == 2]
...
openQuantiles$prob_outbreak[openQuantiles$quartile == 50] <- outbreakProbs$x[outbreakProbs$Group.1 == 3]
