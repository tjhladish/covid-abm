...
.args <- if (interactive()) c(
  ...
  file.path("fig", "res_fig1_noq.png")
...
mtscns <- scn.dt[
  (stockpile == "none" & action == "none") | # nothing
  (stockpile == "low" & active == "passive" & action == "vonly") | # as implemented
  (stockpile == "low-matched" & active == "passive" & action == "vonly") | # extra vaccine
  (stockpile == "low-matched" & active == "risk" & action == "vonly") | # risk-targetted
  (stockpile == "low" & active == "ring" & action == "vonly") | # ring targetted
  (stockpile == "covax" & action == "vonly") # LMIC, risk and ring
]
